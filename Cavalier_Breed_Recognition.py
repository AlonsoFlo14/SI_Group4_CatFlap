...
print('The cavalier directory is : ', cavalier_dir)
print('The unknow directory is : ', unknow_dir)
...
print('Get name of all images...')

train_tensors = paths_to_tensor(train_list)
del  train_list

print('Transformed all images into tensors...')
...
print('About to extract ResNet50 features...')
...
print('Input shape for the CNN : ',train_Resnet50.shape[1:])
